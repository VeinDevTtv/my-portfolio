...
const EnhancedContactForm: React.FC<ContactFormProps> = ({ onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 max-w-md w-full relative overflow-hidden"
    >
      <button
        onClick={onClose}
